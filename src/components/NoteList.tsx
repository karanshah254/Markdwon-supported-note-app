...
export function NoteList({ availableTags, notes, onUpdateTag, onDeleteTag }: NoteListProps) {
    ...
    return (
        <>
            <Row className="align-items-center mb-4">
                ...
                <Col xs="auto">
                    <Stack gap={2} direction="horizontal">
                        ...
                        <Button onClick={() => setShowEditTagsModal(true)} variant="outline-secondary">
                            Edit Tags
                        </Button>
                    </Stack>
                </Col>
            ...
            <EditTagsModal onUpdateTag={onUpdateTag} onDeleteTag={onDeleteTag} show={showEditTagsModal} handleClose={() => setShowEditTagsModal(false)} availableTags={availableTags} />
        </>
    )
}
